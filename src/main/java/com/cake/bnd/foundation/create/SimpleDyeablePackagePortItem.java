...
public class SimpleDyeablePackagePortItem extends PackagePortItem {

    public SimpleDyeablePackagePortItem(final Block block, final Item.Properties properties) {
