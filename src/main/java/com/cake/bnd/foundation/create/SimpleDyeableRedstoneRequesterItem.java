...
public class SimpleDyeableRedstoneRequesterItem extends RedstoneRequesterBlockItem {

    public SimpleDyeableRedstoneRequesterItem(final Block block, final Item.Properties properties) {
